...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 28 22:13:12 2020
...
class Flipkart():
    ...
    def __init__(self):
        ...
        self.driver = webdriver.Chrome(executable_path="/home/awanika/Downloads/chromedriver_linux64/chromedriver")
    ...
    def data_scrap(self):
        ...
        for k in range (0,42):
            page_html = self.driver.page_source
            self.soup = BeautifulSoup(page_html, 'html.parser')
            current_page_mobiles = (self.soup.find_all('div', class_='_3O0U0u'))
            for i in current_page_mobiles:
